...
public class Applicants implements Serializable {
    ...
    {
        return "ClassPojo [message_to_tutor = "+message_to_tutor+", student_level = "+student_level+", is_verified = "+is_verified+", experience_length = "+experience_length+", joined_date = "+joined_date+", talent = "+talent+", registered_location = "+registered_location+", pk = "+pk+"]";
    }
}
